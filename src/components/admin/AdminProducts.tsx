...
export function AdminProducts() {
  ...
  const getTemplateBadge = (templateName: string) => {
    switch(templateName) {
      case 'print-society':
        return <span className="bg-amber-100 text-amber-700 text-[9px] font-black uppercase px-2 py-0.5 rounded tracking-widest">Print Labby App</span>;
      case 'standard':
      default:
        ...
        <div className="p-6 border-b border-gray-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button 
              ...
              className={`p-2.5 rounded-xl border transition-all ${showFilters ? 'bg-primary border-black text-black' : 'bg-white border-gray-200 text-gray-500 hover:border-gray-900 hover:text-black'}`}
            >
                ...
                {(['all', 'visible', 'hidden'] as StatusFilter[]).map((f) => (
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-md text-[9px] font-black uppercase tracking-widest transition-all ${
                      statusFilter === f ? 'bg-primary text-black' : 'text-gray-400 hover:text-black'
                    }`}
                  >
                    {f}
                  </button>
              ...
              <div className="flex bg-white p-1 rounded-lg border border-gray-200 w-fit">
                {(['all', 'in_stock', 'low_stock', 'out_of_stock'] as StockFilter[]).map((f) => (
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-md text-[9px] font-black uppercase tracking-widest transition-all ${
                      stockFilter === f ? 'bg-primary text-black' : 'text-gray-400 hover:text-black'
                    }`}
                  >
                    {f.replace('_', ' ')}
                  </button>
          ...
          <div className="p-20 text-center space-y-4">
             ...
             <div className="pt-6">
               <button 
                 ...
                 className="bg-primary text-black px-8 py-3 rounded-xl font-bold text-[10px] uppercase tracking-widest hover:brightness-90 transition-all shadow-lg"
               >
                 Retry Connection
               </button>
             </div>
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl w-full max-w-4xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <label className={`cursor-pointer rounded-2xl border-2 transition-all p-4 ${template === 'print-society' ? 'border-primary bg-primary/5' : 'border-gray-100 hover:border-gray-200'}`}>
                    <div className="flex gap-4">
                      ...
                      <div>
                        <span className="block font-black text-xs uppercase tracking-widest text-amber-700 mb-1">Print Labby Custom Flow</span>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-yellow-700 leading-relaxed">
                      To utilize the "Print Labby Custom Flow" effectively, ensure this product has a "Material Width" variant option, a "Finish" modifier (Gloss/Matte), and an active inventory limit if Processing Time calculation is required.
                    </p>
                  </div>
                </div>
              )}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <h5 className="text-[9px] font-black uppercase tracking-widest text-amber-700">PHYSICAL ARCHITECTURE</h5>
                  ...
                  <div className="space-y-4">
                    <h5 className="text-[9px] font-black uppercase tracking-widest text-amber-700">INK COMPATIBILITY REGISTRY</h5>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-primary text-black rounded-lg text-[9px] font-black uppercase tracking-widest hover:brightness-90 transition-all flex items-center gap-2"
                >
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
          ...
          <button onClick={handleSave} className="bg-primary text-black px-6 py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest hover:brightness-90 transition-colors shadow-lg">
            Save Route
          </button>
        </div>
      </div>
