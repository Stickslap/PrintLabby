          ...
          {(["queue", "methods", "settings"] as const).map((view) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${
                activeView === view ? "bg-primary text-black" : "text-gray-400 hover:text-gray-900"
              }`}
            >
              {view}
            </button>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
            <div className="p-6 border-b border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="flex items-center gap-2 px-4 py-2.5 bg-primary text-black rounded-xl text-[10px] font-black uppercase hover:brightness-90 transition-all border border-black">
              ...
              {shippingMethods.map((method) => (
                <div key={method.id} className="p-6 hover:bg-gray-50/30 transition-all flex items-center justify-between group">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button className="p-2.5 bg-gray-50 rounded-xl hover:bg-primary hover:text-black transition-all text-gray-400 border border-gray-100 hover:border-primary">
        ...
        <div className="max-w-2xl mx-auto bg-white border border-gray-200 rounded-[32px] p-10 shadow-sm">
           ...
           <div className="space-y-10">
              ...
              <div className="pt-6 border-t border-gray-100 flex justify-end gap-4">
                 ...
                 <button onClick={handleSaveSettings} className="px-8 py-3 bg-primary text-black rounded-2xl text-[10px] font-black uppercase tracking-widest hover:brightness-90 transition-all shadow-lg hover:shadow-primary/20">Apply Protocol</button>
              </div>
           </div>
        </div>
      )}
