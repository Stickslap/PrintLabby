        ...
        <div className="bg-gray-50/50 p-4 border border-gray-100 rounded-xl">
          ...
          <div className="space-y-3">
            <input 
              ...
              className="w-full p-3 border border-gray-200 bg-white rounded-xl text-sm outline-none focus:border-primary file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-black hover:file:brightness-90"
            />
            {proofUrl && (
            ...
            <button 
              ...
              disabled={isCompressing || !proofUrl}
              className="w-full bg-primary text-black px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:brightness-90 transition-colors disabled:opacity-50"
            >
              {isCompressing ? 'Compressing...' : 'Attach Proof'}
            </button>
          </div>
        </div>
      </div>
