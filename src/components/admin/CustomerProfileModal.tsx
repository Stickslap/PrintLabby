                ...
                <div className="space-y-12">
                  ...
                  <div className="pt-6 border-t border-gray-100 flex justify-end">
                    <button 
                      onClick={handleSave}
                      disabled={saving}
                      className="bg-primary text-black px-10 py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-3 shadow-lg shadow-primary/20 hover:opacity-90 transition-all disabled:opacity-50"
                    >
              ...
              {activeTab === 'address' && (
                <div className="space-y-6">
                  <div className="flex gap-4 mb-8">
                    <button className="bg-gray-900 text-black px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:brightness-90 transition">
