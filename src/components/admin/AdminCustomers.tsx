                ...
                <tr key={idx} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 px-6 text-right">
                    <button 
                      ...
                      className="p-2 px-4 bg-gray-100 text-black hover:bg-primary hover:text-black rounded-lg transition-all text-[10px] font-bold uppercase"
                    >
                      View Profile
                    </button>
                  </td>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="text-right">
                  <a 
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 p-2 px-4 bg-primary text-black rounded-lg text-[10px] font-bold uppercase transition-transform hover:-translate-y-0.5"
                  >
                        ...
                        {profile.orders.map((o: any, i: number) => (
                          <tr key={i}>
                            ...
                            <td className="py-3 px-4">
                              <span className={`text-[9px] font-black px-2 py-0.5 rounded uppercase ${getOrderStatusStyle(o.status)}`}>
                                {o.status}
                              </span>
                            </td>
