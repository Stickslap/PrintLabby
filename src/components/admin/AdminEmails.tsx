...
export function AdminEmails() {
  ...
  const [testEmail, setTestEmail] = useState("support@printlabby.com");
    ...
    <div className="max-w-[1240px] mx-auto space-y-12 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-8 py-5 bg-primary text-black rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-primary transition-all shadow-xl shadow-primary/20 flex items-center gap-3">
            ...
            <div className="flex flex-1 max-w-2xl w-full gap-4 relative z-10">
              <div className="flex-1 bg-white rounded-2xl flex items-center px-6 border border-white shadow-sm focus-within:ring-4 focus-within:ring-primary/5 transition-all">
                <input 
                  ...
                  placeholder="support@printlabby.com"
                />
              </div>
              <button 
                onClick={handleSendTest}
                disabled={isSendingTest}
                className="px-10 py-4 bg-primary text-black rounded-2xl text-[11px] font-black uppercase tracking-widest hover:brightness-90 transition-all active:scale-95 disabled:opacity-50 shadow-xl"
              >
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-10 mb-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <button 
                onClick={handleSave}
                disabled={saving}
                className="px-12 py-5 bg-primary text-black rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-primary transition-all shadow-xl shadow-primary/10 flex items-center gap-4 disabled:opacity-50"
              >
                {saving ? (
          ...
          <div className="mt-20 pt-16 border-t border-gray-50 flex flex-col sm:flex-row items-center justify-between gap-10">
            ...
            <button 
              onClick={handleSave}
              disabled={saving}
              className="w-full sm:w-auto px-20 py-7 bg-primary text-black rounded-[32px] text-sm font-black uppercase tracking-[0.4em] hover:bg-primary transition-all shadow-[0_20px_50px_rgba(255,217,0,0.3)] active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-4"
            >
