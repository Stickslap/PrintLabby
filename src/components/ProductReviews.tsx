      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
        ...
        {!isWriting && (
          <button 
            ...
            className="px-8 py-4 bg-primary text-black rounded-full text-[11px] font-black uppercase tracking-widest hover:bg-primary transition-all shadow-xl shadow-black/10"
          >
            Write a Review
          </button>
        )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="px-8 py-4 bg-primary text-black rounded-full text-[11px] font-black uppercase tracking-widest hover:opacity-90 transition-all disabled:opacity-50"
                >
