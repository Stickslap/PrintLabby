    ...
    <footer className="bg-gray-50 text-gray-900 pt-20 pb-10 border-t border-gray-100">
      <div className="max-w-[1400px] mx-auto px-6">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <form onSubmit={handleSubmit} className="flex gap-2 max-w-sm">
              ...
              <button 
                type="submit"
                disabled={loading}
                className="bg-primary text-black px-6 py-3 font-bold uppercase text-xs tracking-widest hover:opacity-90 transition-all flex items-center gap-2 rounded-xl disabled:opacity-50"
              >
        ...
        <div className="pt-10 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em]">© 2026 PRINT LABBY | ALL RIGHTS RESERVED.</p>
        </div>
      </div>
    </footer>
  );
