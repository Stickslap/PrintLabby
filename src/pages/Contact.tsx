      ...
      try {
        await fetch(`/api/contact`, {
          ...
          body: JSON.stringify({ 
            ...
            message,
            orderId,
            notificationEmail: settings?.notificationEmail || settings?.contactEmail || "support@printlabby.com"
          })
        });
      } catch (bcErr) {
      ...
      <div className="min-h-screen bg-white pt-24 pb-20 px-6 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-gray-500 font-medium leading-relaxed">
            Your inquiry has been logged in our system. A Print Labby representative will review your request and get back to you shortly.
          </p>
          <button 
            ...
            >
              <form className="space-y-8" onSubmit={handleSubmit}>
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full bg-primary text-black py-5 rounded-2xl font-headline font-black uppercase tracking-[0.2em] italic text-[13px] hover:brightness-90 transition-all flex items-center justify-center gap-3 shadow-xl disabled:opacity-50"
                >
