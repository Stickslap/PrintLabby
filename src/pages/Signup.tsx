...
export function Signup() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black overflow-y-auto overflow-x-hidden selection:bg-primary selection:text-black">
      {/* Video Background */}
                ...
                <div className="flex flex-col items-center gap-2">
                  <div 
                    className={`w-10 h-10 rounded-full flex items-center justify-center text-[11px] font-black transition-all duration-500 border-2 ${
                      step >= s.id ? "bg-primary border-primary text-black shadow-[0_0_20px_rgba(255,217,0,0.4)]" : "bg-white/5 border-white/10 text-white/20"
                    }`}
                  >
                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    <div className="pt-8">
                      <button 
                        onClick={nextStep}
                        className="w-full bg-primary text-black py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:bg-primary/90 active:scale-95 flex items-center justify-center gap-3 group shadow-[0_20px_40px_-10px_rgba(255,217,0,0.4)]"
                      >
                        Continue to Profile
                ...
                {step === 2 && (
                  ...
                  >
                    ...
                    <div className="flex gap-4 pt-8">
                      ...
                      <button 
                        onClick={nextStep}
                        className="flex-[2] bg-primary text-black py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:bg-primary/90 active:scale-95 flex items-center justify-center gap-3 shadow-[0_20px_40px_-10px_rgba(255,217,0,0.4)]"
                      >
                        Last Step
                  ...
                  >
                    ...
                    <div className="flex gap-4 pt-8">
                      ...
                      <button 
                        ...
                        disabled={loading}
                        className="flex-[2] bg-primary text-black py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:bg-primary/90 active:scale-95 flex items-center justify-center gap-3 shadow-[0_20px_40px_-10px_rgba(255,217,0,0.4)] disabled:opacity-50"
                      >
