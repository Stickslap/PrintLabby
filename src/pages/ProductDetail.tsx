...
export function ProductDetail() {
      ...
      reader.onloadend = async () => {
        try {
          ...
          if (file.type.startsWith('image/')) {
            ...
            setArtworkDataUrl(compressed);
          } else {
            setArtworkDataUrl(base64);
          }
          toast.success("Artwork loaded");
        } catch (err) {
          console.error("Failed to process artwork", err);
  ...
  const heroTitle = getCustomField('hero_title') || heroData?.title || "THE PRINT LABBY METHOD";
    ...
    return (
      <div className="pt-32 pb-20 bg-[#fafafa] min-h-screen">
        <div className="max-w-7xl mx-auto px-6">
          <button 
            onClick={() => navigate(-1)} 
            className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest mb-12 hover:text-amber-700 transition-colors"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
            ...
            <div className="lg:col-span-7">
              ...
              <span className="text-xs font-black uppercase tracking-[0.2em] text-gray-500 block mb-6">PRINT LABBY —</span>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 border-dashed mt-auto">
                <div className="flex items-center gap-2 mb-4">
                   <div className="w-6 h-6 bg-[#f5f3ff] text-amber-700 rounded-full flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16 text-[#000]">
            ...
            <div className="bg-white border border-gray-200 rounded-3xl overflow-hidden self-start shadow-sm flex flex-col">
              <div className="p-4 border-b border-gray-100 bg-[#f9fafb] flex items-center gap-2">
                 <div className="text-amber-700 font-black text-sm">#</div>
                 <h3 className="text-[10px] font-black uppercase tracking-widest">PROCUREMENT</h3>
              </div>
              <div className="p-6 flex-1 flex flex-col">
                 <button className="w-full py-4 border border-gray-100 rounded-xl text-[10px] font-black uppercase text-amber-700 tracking-widest mb-6">
                   STICKERS
                 </button>
                 ...
                 <div className="bg-[#0A0D14] rounded-2xl p-6 text-center text-white mb-4 mt-auto">
                   ...
                   <div className="flex items-center justify-center gap-2">
                    <span className="text-4xl font-headline font-black italic text-[#8B5CF6] tracking-tighter">${(currentPrice || 0).toFixed(2)}</span>
                     <span className="text-[10px] font-black text-amber-700 bg-[#2e1065] px-2 py-1 rounded max-h-min">${(currentPrice || 0).toFixed(2)}/EA</span>
                   </div>
                 </div>
                 ...
                 <div className="bg-[#fbbf24] rounded-xl p-4 flex items-center justify-center gap-2 text-[#92400e] hover:brightness-105 cursor-pointer transition-all">
                   ...
                   <span className="text-[9px] font-black uppercase tracking-widest">EARN $0.50 PRINT LABBY CREDIT</span>
                 </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-3xl overflow-hidden self-start shadow-sm">
              <div className="p-4 border-b border-gray-100 bg-[#f9fafb] flex items-center gap-2">
                 <div className="text-amber-700"><ArrowLeft className="w-4 h-4 rotate-180" /></div>
              ...
              <div className="p-6">
                ...
                <div className="relative border border-dashed border-gray-200 rounded-2xl p-8 flex flex-col items-center justify-center bg-gray-50/50 mb-6 cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  {artworkDataUrl ? (
                    ...
                    <div className="flex flex-col items-center animate-pulse">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest mb-1 text-center">PROCESSING ARTWORK...</span>
                    </div>
                  ) : (
                    <>
                ...
                <div className="space-y-3">
                  ...
                  <button 
                    ...
                    disabled={currentVariant?.purchasing_disabled}
                    className="w-full py-4 bg-primary text-black rounded-xl text-[10px] font-black uppercase tracking-widest hover:brightness-90 transition-colors flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 disabled:opacity-30 disabled:cursor-not-allowed disabled:shadow-none"
                  >
            ...
            <div className="w-full border border-gray-200 rounded-3xl overflow-hidden shadow-sm bg-white">
              ...
              <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-4">
                  <h4 className="text-[10px] font-black uppercase text-amber-700 tracking-widest mb-6">PHYSICAL ARCHITECTURE</h4>
                ...
                <div>
                  <h4 className="text-[10px] font-black uppercase text-amber-700 tracking-widest mb-6">INK COMPATIBILITY REGISTRY</h4>
                  <div className="space-y-3">
          ...
          <div className="flex flex-col">
            ...
            {product.options && product.options.map((option) => (
              <div key={option.id} className="mb-6">
                <label className="block text-[10px] font-black uppercase tracking-widest text-amber-700 mb-3">
                  {option.display_name}
                </label>
                    ...
                    return (
                      <button 
                        ...
                        className={`px-6 py-3 border rounded-xl text-xs font-bold transition-colors ${
                          isSelected ? 'border-primary bg-primary text-black shadow-lg shadow-primary/20' : 'border-gray-200 hover:border-black hover:bg-gray-50'
            ...
            <div className="space-y-3 mb-16">
              <button 
                onClick={handleAddToCart}
                disabled={currentVariant?.purchasing_disabled}
                className="w-full bg-primary text-black py-5 rounded-full text-[15px] font-bold uppercase tracking-wider hover:opacity-90 transition-all flex items-center justify-center gap-3 shadow-lg shadow-primary/20 disabled:opacity-30 disabled:cursor-not-allowed disabled:shadow-none"
              >
