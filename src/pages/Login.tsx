               ...
               <form onSubmit={handleForgotPassword} className="space-y-6">
                  ...
                  <div className="flex flex-col gap-4 pt-2">
                     <button 
                       type="submit" 
                       disabled={loading}
                       className="w-full bg-primary text-black py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:bg-primary/90 active:scale-95 disabled:opacity-50"
                     >
               ...
               <form onSubmit={handleAuth} className="space-y-6">
                  ...
                  <div className="pt-4">
                     <button 
                       type="submit" 
                       disabled={loading}
                       className="w-full bg-primary text-black py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:bg-primary/90 active:scale-95 disabled:opacity-50 shadow-[0_20px_40px_-10px_rgba(255,217,0,0.4)]"
                     >
