              ...
              >
                ...
                {activeTab === "legal" && (
                  <div className="prose prose-sm max-w-none text-gray-600">
                    ...
                    <p>All content on this website, including designs, text, graphics, and logos, is the property of Print Labby LLC and is protected by copyright laws.</p>
                  </div>
                )}
                    ...
                    <div className="mb-12">
                      <div className="flex border border-gray-100 rounded-2xl overflow-hidden focus-within:border-black transition-colors focus-within:ring-4 ring-gray-50">
                        ...
                        <button
                          ...
                          className="bg-primary text-black px-8 font-bold uppercase tracking-widest text-[10px] hover:brightness-90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
                          {submitting ? "..." : "Submit"}
                        </button>
                      </div>
